...
//^ Ejm Math.floor(5.99999999) = 5 otro extremista de 0,9 = 0
console.log(Math.floor(12.999999));

//^ Math.ceil(numero_decimal)
//^ Redondea un numero al proximo entero superior
//^ Ejm: Math.ceil(0.2); =1 demasiado
console.log(Math.ceil(0.2));

//^ Math.round(numero_decimal)
//^ Redondea un número respetando las formas normales de redondeo este si es adecuado
...
//^ coge la cantidad de decimal que deseamos contar
//^si escoger con 1 numero decimal entonces lo va redondear como el metodo .round
